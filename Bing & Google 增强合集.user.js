  ...
  if (/bing\.com$/.test(h)) {
    ...
    if (/\/search/.test(location.pathname)) {
      ...
      function injectStyles() {
        ...
        var css = 'body, #b_header { min-width: 0 !important; } html { overflow-x: hidden !important; }';
      ...
      function watchBody() {
        ...
        var target = document.body || document.documentElement; if(target) obs.observe(target,{attributes:true,childList:true,subtree:true,attributeFilter:['class']});
      }
