...
(function () {
  ...
  if (S.get('adBlock', true)) {
    onReady(function () {
      ...
      // --- Phase D: 拦截广告请求 (fetch / XHR) - 优化版 ---
      // 优化广告域名列表，添加更多常见广告域名
      var AD_DOMAINS = [
        'ssp.360.cn', 'mediav.com', 'sspweb', 'doubleclick', 'googlesyndication',
        'pagead', 'googleadservices', 'imasdk.googleapis.com', 'fengkongcloud.cn',
        'openfpcdn.io', 'admaster.com.cn', 'adsmogo.com', 'adsunflower.com',
        'adwhirl.com', 'appier.net', 'bearroo.com', 'inmobi.com', 'mopub.com',
        'smaato.net', 'startapp.com', 'tapjoy.com', 'unity3d.com', 'vungle.com',
        'adcolony.com', 'admob.com', 'adsenseformobileapps.com', 'adsymptotic.com',
        'advertising.com', 'bidswitch.net', 'bluekai.com', 'brealtime.com',
        'casalemedia.com', 'contextweb.com', 'crwdcntrl.net', 'demdex.net',
        'exponential.com', 'eyeota.net', 'freewheel.com', 'gemius.pl',
        'globalssl.net', 'gumgum.com', 'hatena.ne.jp', 'indexww.com',
        'insurads.com', 'intentmedia.net', 'lijit.com', 'liveintent.com',
        'mathtag.com', 'mediaplex.com', 'mgid.com', 'mookie1.com',
        'narrative.io', 'nexage.com', 'nissan.com', 'openx.net',
        'optmd.com', 'outbrain.com', 'permutive.com', 'petsite.com',
        'piano.io', 'pubmatic.com', 'quantserve.com', 'revjet.com',
        'rfihub.com', 'rlcdn.com', 'rubiconproject.com', 'sharethrough.com',
        'simpli.fi', 'sitescout.com', 'skinected.com', 'smartadserver.com',
        'simpli.fi', 'snap.com', 'sonobi.com', 'spotxchange.com',
        'stickyadstv.com', 'taboola.com', 'teads.tv', 'tidaltv.com',
        'trafficjunky.com', 'triplelift.com', 'trustx.org', 'undertone.com',
        'vidazoo.com', 'videoamp.com', 'wideorbit.com', 'widespace.com',
        'yieldmo.com', 'zedo.com', 'zemanta.com', 'zergnet.com'
      ];
      ...
      var AD_VIDEO_DOMAINS = [
        'mediav.com', 'live-s3m.mediav', 's3m.mediav.com', 'doubleclick.net',
        'googlesyndication.com', 'pagead2.googlesyndication.com', 'admaster.com.cn',
        'adsmogo.com', 'adsunflower.com', 'adwhirl.com', 'appier.net',
        'bearroo.com', 'inmobi.com', 'mopub.com', 'smaato.net',
        'startapp.com', 'tapjoy.com', 'unity3d.com', 'vungle.com',
        'adcolony.com', 'admob.com', 'adsenseformobileapps.com', 'adsymptotic.com',
        'advertising.com', 'bidswitch.net', 'bluekai.com', 'brealtime.com',
        'casalemedia.com', 'contextweb.com', 'crwdcntrl.net', 'demdex.net',
        'exponential.com', 'eyeota.net', 'freewheel.com', 'gemius.pl',
      ...
      // 优化：添加广告跳过提示
      function showAdSkipTip() {
        var tip = document.createElement('div');
        tip.id = 'rrmv-ad-skip-tip';
        tip.textContent = '广告已跳过';
        tip.style.cssText = 'position:fixed;top:20px;left:50%;transform:translateX(-50%);background:rgba(0,0,0,0.8);color:#fff;padding:8px 16px;border-radius:4px;font-size:14px;z-index:99999;pointer-events:none;transition:opacity 0.3s';
